...
public class ServerCrashProcedure extends StateMachineProcedure<MasterProcedureEnv, ServerCrashState> implements ServerProcedureInterface {
     ...
     */
    public ServerCrashProcedure(final MasterProcedureEnv env, final ServerName serverName, final boolean shouldSplitWal, final boolean carryingMeta) {
    ...
    void updateProgress(boolean updateState) {
        ...
        status.setStatus(msg + " current State " + currentRunningState + (childrenLatch > 0 ? "; remaining num of running child procedures = " + childrenLatch : ""));
    }
    ...
    protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
        ...
        serializer.serialize(((org.apache.hadoop.hbase.shaded.protobuf.generated.MasterProcedureProtos.ServerCrashStateData) org.zlab.ocov.tracker.Runtime.update(state.build(), 452, serializer)));
    }
    ...
    public static void updateProgress(MasterProcedureEnv env, long parentId) {
        ...
        Procedure parentProcedure = env.getMasterServices().getMasterProcedureExecutor().getProcedure(parentId);
