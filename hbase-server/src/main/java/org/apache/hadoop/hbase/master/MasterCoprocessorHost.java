...
public class MasterCoprocessorHost extends CoprocessorHost<MasterCoprocessor, MasterCoprocessorEnvironment> {
     ...
     */
    private static class MasterEnvironment extends BaseEnvironment<MasterCoprocessor> implements MasterCoprocessorEnvironment {

        private final MetricRegistry metricRegistry;

        private final MasterServices services;

        public MasterEnvironment(final MasterCoprocessor impl, final int priority, final int seq, final Configuration conf, final MasterServices services) {
     ...
     */
    private static class MasterEnvironmentForCoreCoprocessors extends MasterEnvironment implements HasMasterServices {

        private final MasterServices masterServices;

        public MasterEnvironmentForCoreCoprocessors(final MasterCoprocessor impl, final int priority, final int seq, final Configuration conf, final MasterServices services) {
    ...
    @Override
    public MasterEnvironment createEnvironment(final MasterCoprocessor instance, final int priority, final int seq, final Configuration conf) {
        ...
        return instance.getClass().isAnnotationPresent(CoreCoprocessor.class) ? new MasterEnvironmentForCoreCoprocessors(instance, priority, seq, conf, masterServices) : new MasterEnvironment(instance, priority, seq, conf, masterServices);
    }
    ...
    public MasterCoprocessor checkAndGetInstance(Class<?> implClass) throws InstantiationException, IllegalAccessException {
        try {
            if (MasterCoprocessor.class.isAssignableFrom(implClass)) {
                ...
                LOG.error("{} is not of type MasterCoprocessor. Check the configuration of {}", implClass.getName(), CoprocessorHost.MASTER_COPROCESSOR_CONF_KEY);
                return null;
            }
    ...
    private ObserverGetter<MasterCoprocessor, MasterObserver> masterObserverGetter = MasterCoprocessor::getMasterObserver;
    ...
    public void preModifyNamespace(final NamespaceDescriptor currentNsDescriptor, final NamespaceDescriptor newNsDescriptor) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postModifyNamespace(final NamespaceDescriptor oldNsDescriptor, final NamespaceDescriptor currentNsDescriptor) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public TableDescriptor preCreateTableRegionsInfos(TableDescriptor desc) throws IOException {
        ...
        return execOperationWithResult(new ObserverOperationWithResult<MasterObserver, TableDescriptor>(masterObserverGetter, desc) {
    ...
    public void preCreateTableAction(final TableDescriptor htd, final RegionInfo[] regions, final User user) throws IOException {
    ...
    public void postCompletedCreateTableAction(final TableDescriptor htd, final RegionInfo[] regions, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void postCompletedDeleteTableAction(final TableName tableName, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void postCompletedTruncateTableAction(final TableName tableName, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public TableDescriptor preModifyTable(final TableName tableName, final TableDescriptor currentDescriptor, final TableDescriptor newDescriptor) throws IOException {
        if (coprocEnvironments.isEmpty()) {
            return newDescriptor;
        }
        return execOperationWithResult(new ObserverOperationWithResult<MasterObserver, TableDescriptor>(masterObserverGetter, newDescriptor) {
    ...
    public void postModifyTable(final TableName tableName, final TableDescriptor oldDescriptor, final TableDescriptor currentDescriptor) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public String preModifyTableStoreFileTracker(final TableName tableName, final String dstSFT) throws IOException {
        if (coprocEnvironments.isEmpty()) {
            return dstSFT;
        }
        return execOperationWithResult(new ObserverOperationWithResult<MasterObserver, String>(masterObserverGetter, dstSFT) {
    ...
    public void postModifyTableStoreFileTracker(final TableName tableName, final String dstSFT) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public String preModifyColumnFamilyStoreFileTracker(final TableName tableName, final byte[] family, final String dstSFT) throws IOException {
        if (coprocEnvironments.isEmpty()) {
            return dstSFT;
        }
        return execOperationWithResult(new ObserverOperationWithResult<MasterObserver, String>(masterObserverGetter, dstSFT) {
            ...
            @Override
            protected String call(MasterObserver observer) throws IOException {
                return observer.preModifyColumnFamilyStoreFileTracker(this, tableName, family, getResult());
            }
        });
    }

    public void postModifyColumnFamilyStoreFileTracker(final TableName tableName, final byte[] family, final String dstSFT) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void preModifyTableAction(final TableName tableName, final TableDescriptor currentDescriptor, final TableDescriptor newDescriptor, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void postCompletedModifyTableAction(final TableName tableName, final TableDescriptor oldDescriptor, final TableDescriptor currentDescriptor, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void postCompletedEnableTableAction(final TableName tableName, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void postCompletedDisableTableAction(final TableName tableName, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void preAbortProcedure(final ProcedureExecutor<MasterProcedureEnv> procEnv, final long procId) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
     ...
     * @param user        the user
     */
    public void postCompletedSplitRegionAction(final RegionInfo regionInfoA, final RegionInfo regionInfoB, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
     ...
     * @param user           the user
     */
    public void preMergeRegionsAction(final RegionInfo[] regionsToMerge, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
     ...
     * @param user           the user
     */
    public void postCompletedMergeRegionsAction(final RegionInfo[] regionsToMerge, final RegionInfo mergedRegion, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
     ...
     * @param user           the user
     */
    public void preMergeRegionsCommit(final RegionInfo[] regionsToMerge, @MetaMutationAnnotation final List<Mutation> metaEntries, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
     ...
     * @param user           the user
     */
    public void postMergeRegionsCommit(final RegionInfo[] regionsToMerge, final RegionInfo mergedRegion, final User user) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation(user) {
    ...
    public void preSetRegionServerQuota(final String regionServer, final GlobalQuotaSettings quotas) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postSetRegionServerQuota(final String regionServer, final GlobalQuotaSettings quotas) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void preBalanceRSGroup(final String name, final BalanceRequest request) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postBalanceRSGroup(final String name, final BalanceRequest request, final BalanceResponse response) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void preUpdateRSGroupConfig(final String groupName, final Map<String, String> configuration) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postUpdateRSGroupConfig(final String groupName, final Map<String, String> configuration) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postSwitchRpcThrottle(final boolean oldValue, final boolean newValue) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
    ...
    public void postSwitchExceedThrottleQuota(final boolean oldValue, final boolean newValue) throws IOException {
        execOperation(coprocEnvironments.isEmpty() ? null : new MasterObserverOperation() {
