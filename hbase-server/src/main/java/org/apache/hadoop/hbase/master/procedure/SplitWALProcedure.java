...
public class SplitWALProcedure extends StateMachineProcedure<MasterProcedureEnv, MasterProcedureProtos.SplitWALState> implements ServerProcedureInterface {
    ...
    protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
        ...
        serializer.serialize(((org.apache.hadoop.hbase.shaded.protobuf.generated.MasterProcedureProtos.SplitWALData) org.zlab.ocov.tracker.Runtime.update(builder.build(), 461, serializer)));
    }
    ...
    protected void afterReplay(MasterProcedureEnv env) {
        if (worker != null) {
            if (env != null && env.getMasterServices() != null && env.getMasterServices().getSplitWALManager() != null) {
