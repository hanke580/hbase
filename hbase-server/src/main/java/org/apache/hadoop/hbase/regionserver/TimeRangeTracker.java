...
public abstract class TimeRangeTracker {
     ...
     */
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "MT_CORRECTNESS", justification = "Intentional")
    ...
    @VisibleForTesting
    public static class //In order to estimate the heap size, this inner class need to be accessible to TestHeapSize.
    NonSyncTimeRangeTracker extends TimeRangeTracker {
    ...
    @VisibleForTesting
    public static class //In order to estimate the heap size, this inner class need to be accessible to TestHeapSize.
    SyncTimeRangeTracker extends TimeRangeTracker {
