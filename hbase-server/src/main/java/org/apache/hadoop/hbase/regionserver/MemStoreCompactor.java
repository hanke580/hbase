...
public class MemStoreCompactor {
    ...
    public boolean start() throws IOException {
        ...
        org.zlab.ocov.tracker.Runtime.update(this, 872);
    ...
    private ImmutableSegment createSubstitution(MemStoreCompactionStrategy.Action action) throws IOException {
        ...
        switch(action) {
            case COMPACT:
                iterator = new MemStoreCompactorSegmentsIterator(segments, compactingMemStore.getComparator(), compactionKVMax, compactingMemStore.getStore());
