...
public class HFileBlockIndex {
    ...
    static class ByteArrayKeyBlockIndexReader extends BlockIndexReader {
        ...
        public ByteArrayKeyBlockIndexReader(final int treeLevel, final CachingBlockReader cachingBlockReader) {
            this(treeLevel);
    ...
    static class CellBasedKeyBlockIndexReader extends BlockIndexReader {
        ...
        public CellBasedKeyBlockIndexReader(final CellComparator c, final int treeLevel, final CachingBlockReader cachingBlockReader) {
            this(c, treeLevel);
            this.cachingBlockReader = cachingBlockReader;
        }
    ...
    static abstract class BlockIndexReader implements HeapSize {
         ...
         * @throws IOException
         */
        public HFileBlock seekToDataBlock(final Cell key, HFileBlock currentBlock, boolean cacheBlocks, boolean pread, boolean isCompaction, DataBlockEncoding expectedDataBlockEncoding) throws IOException {
         ...
         * @throws IOException
         */
        public abstract BlockWithScanInfo loadDataBlockWithScanInfo(Cell key, HFileBlock currentBlock, boolean cacheBlocks, boolean pread, boolean isCompaction, DataBlockEncoding expectedDataBlockEncoding) throws IOException;
    ...
    public static class BlockIndexWriter implements InlineBlockWriter {
        ...
        public void writeSingleLevelIndex(DataOutput out, String description) throws IOException {
            ...
            curInlineChunk = ((BlockIndexChunk) org.zlab.ocov.tracker.Runtime.update(new BlockIndexChunk(), 148, out, description));
            if (LOG.isTraceEnabled()) {
        ...
        private BlockIndexChunk writeIntermediateLevel(FSDataOutputStream out, BlockIndexChunk currentLevel) throws IOException {
            ...
            BlockIndexChunk curChunk = ((BlockIndexChunk) org.zlab.ocov.tracker.Runtime.update(new BlockIndexChunk(), 149, out, currentLevel));
        ...
        private void writeIntermediateBlock(FSDataOutputStream out, BlockIndexChunk parent, BlockIndexChunk curChunk) throws IOException {
            ...
            curChunk.clear();
            org.zlab.ocov.tracker.Runtime.update(curChunk, 150, out, parent, curChunk);
            curFirstKey = null;
        }
