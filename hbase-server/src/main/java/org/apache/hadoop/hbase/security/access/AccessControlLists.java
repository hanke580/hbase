...
public class AccessControlLists {
            ...
            for (UserPermission perm : permsList) {
                ...
                if (Bytes.toString(perm.getUser()).equals(Bytes.toString(userPerm.getUser()))) {
                    ...
                    if (!remainingActions.isEmpty()) {
                        ...
                        org.zlab.ocov.tracker.Runtime.update(perm, 163, conf, userPerm, t);
    ...
    @VisibleForTesting
    public static ListMultimap<String, TablePermission> getNamespacePermissions(Configuration conf, String namespace) throws IOException {
