...
public class HStoreFile implements StoreFile, StoreFileReader.Listener {
    ...
    public HStoreFile(FileSystem fs, StoreFileInfo fileInfo, Configuration conf, CacheConfig cacheConf, BloomType cfBloomType, boolean primaryReplica) {
        ...
        this.noReadahead = conf.getBoolean(STORE_FILE_READER_NO_READAHEAD, DEFAULT_STORE_FILE_READER_NO_READAHEAD);
    ...
    private void open() throws IOException {
        ...
        this.reader = fileInfo.open(this.fs, this.cacheConf, false, noReadahead ? 0L : -1L, primaryReplica, refCount, true);
        // Load up indices and fileinfo. This also loads Bloom filter type.
        metadataMap = Collections.unmodifiableMap(this.reader.loadFileInfo());
        org.zlab.ocov.tracker.Runtime.update(this, 51);
        ...
        if (b != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(this, 52);
            if (fileInfo.isTopReference()) {
                this.sequenceid += 1;
                org.zlab.ocov.tracker.Runtime.update(this, 53);
            }
        }
        if (isBulkLoadResult()) {
            ...
            if (startPos != -1) {
                ...
                org.zlab.ocov.tracker.Runtime.update(this, 54);
                // Handle reference files as done above.
                if (fileInfo.isTopReference()) {
                    this.sequenceid += 1;
                    org.zlab.ocov.tracker.Runtime.update(this, 55);
                }
            }
            ...
            if (skipResetSeqId) {
                ...
                this.sequenceid += 1;
                org.zlab.ocov.tracker.Runtime.update(this, 56);
            }
        ...
        if (b != null) {
            ...
            org.zlab.ocov.tracker.Runtime.update(this, 57);
        }
    ...
    private StoreFileReader createStreamReader(boolean canUseDropBehind) throws IOException {
        initReader();
        StoreFileReader reader = fileInfo.open(this.fs, this.cacheConf, canUseDropBehind, -1L, primaryReplica, refCount, false);
    ...
    public StoreFileScanner getStreamScanner(boolean canUseDropBehind, boolean cacheBlocks, boolean isCompaction, long readPt, long scannerOrder, boolean canOptimizeForNonNullColumn) throws IOException {
        ...
        StoreFileScanner sfScanner = reader.getStoreFileScanner(cacheBlocks, false, isCompaction, readPt, scannerOrder, canOptimizeForNonNullColumn);
    ...
    public synchronized void closeStoreFile(boolean evictOnClose) throws IOException {
        if (this.reader != null) {
            ...
            this.reader = null;
            org.zlab.ocov.tracker.Runtime.update(this, 58, evictOnClose);
        }
    ...
    public void closeStreamReaders(boolean evictOnClose) throws IOException {
        synchronized (this) {
            ...
            Preconditions.checkState(size == 0, "There are still streamReaders post close: " + size);
        }
    }
