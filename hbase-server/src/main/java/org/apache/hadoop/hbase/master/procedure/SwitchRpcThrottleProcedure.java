...
public class SwitchRpcThrottleProcedure extends StateMachineProcedure<MasterProcedureEnv, SwitchRpcThrottleState> implements ServerProcedureInterface {
    ...
    protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
        ...
        serializer.serialize(((org.apache.hadoop.hbase.shaded.protobuf.generated.MasterProcedureProtos.SwitchRpcThrottleStateData) org.zlab.ocov.tracker.Runtime.update(SwitchRpcThrottleStateData.newBuilder().setRpcThrottleEnabled(rpcThrottleEnabled).build(), 151, serializer)));
    }
