...
public class OpenRegionHandler extends EventHandler {
    ...
    private void doCleanUpOnFailedOpen(HRegion region) throws IOException {
        try {
            ...
            rsServices.reportRegionStateTransition(((RegionStateTransitionContext) org.zlab.ocov.tracker.Runtime.update(new RegionStateTransitionContext(TransitionCode.FAILED_OPEN, HConstants.NO_SEQNUM, -1, regionInfo), 46, region)));
        }
    }
    ...
    static class PostOpenDeployTasksThread extends Thread {
        ...
        public void run() {
            try {
                org.zlab.ocov.tracker.Runtime.update(this, 47);
