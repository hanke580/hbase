...
public final class SnapshotManifest {
    ...
    private SnapshotManifest(final Configuration conf, final FileSystem fs, final Path workingDir, final SnapshotDescription desc, final ForeignExceptionSnare monitor) {
     ...
     */
    public static SnapshotManifest create(final Configuration conf, final FileSystem fs, final Path workingDir, final SnapshotDescription desc, final ForeignExceptionSnare monitor) {
    ...
    interface RegionVisitor<TRegion, TFamily> {
        ...
        void storeFile(final TRegion region, final TFamily family, final StoreFileInfo storeFile) throws IOException;
    }
    ...
    @VisibleForTesting
    protected void addRegion(final Path tableDir, final RegionInfo regionInfo, RegionVisitor visitor) throws IOException {
