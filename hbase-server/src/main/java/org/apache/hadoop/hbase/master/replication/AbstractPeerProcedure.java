...
public abstract class AbstractPeerProcedure<TState> extends StateMachineProcedure<MasterProcedureEnv, TState> implements PeerProcedureInterface {
    ...
    protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
        ...
        serializer.serialize(((org.apache.hadoop.hbase.shaded.protobuf.generated.MasterProcedureProtos.PeerProcedureStateData) org.zlab.ocov.tracker.Runtime.update(PeerProcedureStateData.newBuilder().setPeerId(peerId).build(), 15, serializer)));
    }
