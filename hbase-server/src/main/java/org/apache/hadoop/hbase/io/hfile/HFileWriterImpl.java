...
public class HFileWriterImpl implements HFile.Writer {
    ...
    private void writeInlineBlocks(boolean closing) throws IOException {
        for (InlineBlockWriter ibw : inlineBlockWriters) {
            ...
            org.zlab.ocov.tracker.Runtime.update(ibw, 0);
        }
    }
    ...
    public void close() throws IOException {
        ...
        FixedFileTrailer trailer = ((FixedFileTrailer) org.zlab.ocov.tracker.Runtime.update(new FixedFileTrailer(getMajorVersion(), getMinorVersion()), 1));
