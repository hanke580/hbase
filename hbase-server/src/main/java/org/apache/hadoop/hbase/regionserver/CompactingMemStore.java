...
public class CompactingMemStore extends AbstractMemStore {
    ...
    public static final long DEEP_OVERHEAD = ClassSize.align(// Store,
    AbstractMemStore.DEEP_OVERHEAD + 6 * ClassSize.REFERENCE + // CompactionPipeline,
    ...
    2 * Bytes.SIZEOF_BOOLEAN + // inMemoryCompactionInProgress and allowCompaction
    ...
    private void pushTailToSnapshot() {
        ...
        org.zlab.ocov.tracker.Runtime.update(segments, 467);
    ...
    private void pushPipelineToSnapshot() {
        ...
        while (!done) {
            ...
            org.zlab.ocov.tracker.Runtime.update(segments, 470);
            pushToSnapshot(segments.getStoreSegments());
