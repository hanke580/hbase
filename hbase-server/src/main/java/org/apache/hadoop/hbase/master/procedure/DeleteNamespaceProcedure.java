...
public class DeleteNamespaceProcedure extends AbstractStateMachineNamespaceProcedure<DeleteNamespaceState> {
    ...
    public DeleteNamespaceProcedure(final MasterProcedureEnv env, final String namespaceName, final ProcedurePrepareLatch latch) {
        super(env, latch);
    ...
    @Override
    protected Flow executeFromState(final MasterProcedureEnv env, final DeleteNamespaceState state) throws InterruptedException {
    ...
    @Override
    protected void rollbackState(final MasterProcedureEnv env, final DeleteNamespaceState state) throws IOException {
    ...
    protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
        ...
        serializer.serialize(((org.apache.hadoop.hbase.shaded.protobuf.generated.MasterProcedureProtos.DeleteNamespaceStateData) org.zlab.ocov.tracker.Runtime.update(deleteNamespaceMsg.build(), 444, serializer)));
    }

    @Override
    protected void deserializeStateData(ProcedureStateSerializer serializer) throws IOException {
        super.deserializeStateData(serializer);
        MasterProcedureProtos.DeleteNamespaceStateData deleteNamespaceMsg = serializer.deserialize(MasterProcedureProtos.DeleteNamespaceStateData.class);
     ...
     */
    protected static void deleteFromNSTable(final MasterProcedureEnv env, final String namespaceName) throws IOException {
     ...
     * @param namespaceName name of the namespace in string format
     */
    protected static void removeFromZKNamespaceManager(final MasterProcedureEnv env, final String namespaceName) throws IOException {
     ...
     * @param namespaceName name of the namespace in string format
     */
    protected static void removeNamespaceQuota(final MasterProcedureEnv env, final String namespaceName) throws IOException {
